    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden w-full max-w-5xl flex flex-col md:flex-row">
        ...
        <div class="p-8 md:w-1/2 flex flex-col justify-center space-y-6 bg-white w-full md:max-w-md mx-auto">
            <div class="text-center">
                <h2 class="text-2xl font-semibold text-green-600">Masuk Akun</h2>
            ...
            <form wire:submit="login" class="space-y-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" wire:navigate
                            class="text-green-600 hover:text-green-500 transition-colors">Lupa password?</a>
                    @endif
                </div>
                ...
                <button type="submit"
                    ...
                    wire:loading.class="opacity-70 cursor-wait" wire:target="login" wire:loading.attr="disabled">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Belum punya akun?
                <a href="{{ route('register') }}" wire:navigate class="text-green-600 font-medium hover:underline">
                    Daftar Sekarang
                </a>
            </p>
        </div>
