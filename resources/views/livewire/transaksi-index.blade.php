                        ...
                        <tbody>
                            @forelse ($transaksis as $t)
                                <tr class="border-b hover:bg-gray-50 transition">
                                    <td class="px-4 py-3 font-medium break-words max-w-[150px]">{{ $t->keterangan }}
                                    </td>
                                    <td class="px-4 py-3 font-semibold">Rp{{ number_format($t->nominal, 0, ',', '.') }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        @if ($t->status === 'Withdraw')
                                            ...
                                            @endphp
                                            @if ($asal && $tujuan)
                                                {{ $asal }} <span class="text-gray-400">➜</span>
                                                {{ $tujuan }}
                                            @else
                                                {{ $asal ?? ($tujuan ?? '-') }}
                                            @endif
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-4 text-gray-500">Belum ada data transaksi.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    @forelse ($transaksis as $t)
                        ...
                        <div class="border rounded-xl shadow-sm p-4 bg-gray-50">
                            ...
                            <div class="mt-1 text-sm text-gray-600">
                                <p><span class="font-medium">Kategori:</span> {{ $t->kategori->nama_kategori ?? '-' }}
                                </p>
                                <p>
