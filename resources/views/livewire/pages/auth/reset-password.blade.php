            ...
            <form wire:submit="resetPassword" class="space-y-4">
                ...
                <div>
                    ...
                    <x-text-input wire:model="email" id="email" type="email" name="email" readonly
                        class="block w-full mt-2 rounded-xl border-gray-300 bg-gray-100 cursor-not-allowed focus:ring-green-500 focus:border-green-500" />
                ...
                <div class="relative">
                    ...
                    <button type="button" id="togglePasswordReset"
                        class="absolute right-3 top-10 text-gray-500 hover:text-green-600">👁️</button>
